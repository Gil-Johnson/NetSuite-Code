function pageInit(type) {
    if(type == 'copy'){
        ...
        try{    
            ...
            nlapiSelectLineItem('itemvendor', x);
            nlapiSetCurrentLineItemValue('vendorcode', null);
            nlapiCommitLineItem('itemvendor');
                    
                 //   nlapiRemoveLineItem('itemvendor', x);
            	//	   nlapisetCurrentLineItemValue('itemvendor', 'vendorcode', x, null);

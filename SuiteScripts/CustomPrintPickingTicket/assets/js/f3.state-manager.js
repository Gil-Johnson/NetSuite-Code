...
function StateManager($grid) {
    ...
    this.saveCurrentState = function (page) {
        ...
        $.jStorage.set('uidata_' + page, data);

        console.log('saveCurrentState(); // page = ', page);
        console.log('saveCurrentState(); // saved data = ' , $.jStorage.get('uidata_' + page));
    ...
    this.reloadCurrentState = function(page) {
        console.log('reloadCurrentState();testing1');
        var reloadCurrentStateStopWatch = StopWatch.start('reloadCurrentState()');

        var data = $.jStorage.get('uidata_' + page);
    ...
    this.getAllData = function () {
        ...
        var dataArr = [];
        for (var i = 1; i <= 100; i++) {
            var data = $.jStorage.get('uidata_' + i);
            if (!!data) {
                dataArr.push(data);

    ...
    if(console.log("reloadCurrentState(); // page = ",a)
        ...
        var g=e.checkbox.items,
            ...
            i=c.find(".close-checkbox").filter(function(){
                ...
                if(b){
                    var c =_.matcher({ order:a,item:b });
                    return _.findIndex(g,c)>-1
                }
                return h.indexOf(a)>-1});i.prop("checked",!1).click();
                var j=c.find("tr[id]");
                _.each(e.salesorders,function(a,b,c){
                var d=a,e=d.row_id,f=j.filter("#"+e);
                ...
                if(d.cancel_date!=d.orig_cancel_date){
                    ...
                    h.attr("data-orig-value",d.orig_cancel_date),
                        ...
                        f.addClass("modified-cancel-date")}_.each(d.items,function(a,b){

var Constants = {
    api_url: "https://forms.na3.netsuite.com/app/site/hosting/scriptlet.nl?script=360&deploy=1&compid=3500213&h=2cec6e4378562fb5b62d",
    ...
    download_initializing_url: "https://forms.na3.netsuite.com/app/site/hosting/scriptlet.nl?script=340&deploy=1&compid=3500213&h=9f0dc4aefd3cbcc88823",
    download_status_check_url: "https://support.na3.sparowatch.com/imagedownloader/checkstatus.php",
...
function getApiUrlWithFilters() {
    ...
    var selectedDis = $('#dis').prop('checked');
    
   // alert($('#dis').prop('checked'));
...
function downloadImages(){
	...
	var suiteletURL = 'https://forms.na3.netsuite.com/app/site/hosting/scriptlet.nl?script=340&deploy=1&compid=3500213&h=9f0dc4aefd3cbcc88823';
    var selectedRows = $('#searchResultContainer').jtable('selectedRows');
    var selectedTeamsText = $('#team option:selected').text();
    var selectedProdTypesText = $('#prod-type option:selected').text();
    var timeOutSec = 400;
    
    timeOutSec = timeOutSec * selectedRows.length;
    ...
    if(!!selectedRows && selectedRows.length > 0) {
       ...
       // alert(selectedRows.length);
        ...
        if(selectedRows){
            suiteletURL += '&items=' + files.toString();
         }
...
//            url: "https://forms.na3.netsuite.com/app/site/hosting/scriptlet.nl?script=340&deploy=1&compid=3500213&h=9f0dc4aefd3cbcc88823", //Constants.download_initializing_url + "?reqid=" + Math.floor((Math.random()*1000)+1),
//            type: 'GET',
//            data: {

...
function StateManager($grid, prefix) {
    ...
    this.reloadCurrentState = function(page) {
        console.log('reloadCurrentState();');
    ...
    this.getSelectedData = function() {
        ...
        $closeCheckboxes.each(function () {
            ...
            var qtyCommitted = row.getAttribute('jqGrid_quantity_committed');
    ...
    this.getAllData = function () {
        ...
        // now get all selections from localstorage //removed prints: [] after items: [] and comma
        var finalData = {
            checkbox: {
                orders: [],
                items: []

...
var F3BaseUISuitelet = Fiber.extend(function () {
    return {
         ...
         */
        getFileUrl: function () {
            return "SuiteScripts/WaveGeneration_v1/assets/template.html";
        },

        getDependencyFileIds: function() {
            // v2.2
            var fileIds = [
                1963277, // bootstrap-datepicker3.min.css
                1963371, // ui.jqgrid-bootstrap.css
                1963471, // f3.ppt.css
                1963273, // f3.ppt.min.css

                1963269, // jquery-1.11.0.min.js
                1963268, // jquery.jqGrid.min.js
                1963469, // grid.locale-en.js

                1963473, // fiber.min.js
                1963372, // underscore-min.js
                1963275, // jstorage.js

                1963475, // f3.init.js
                1963271, // f3.ui-manager.js
                1963374, // f3.data-manager.js
                1963377, // f3.state-manager.js
                1963472, // f3.tooltip-manager.js

                1963270, // f3.ppt.min.js
                1963277, // bootstrap-datepicker.min.js
                1963368 // typeahead.jquery.min.js
            ];

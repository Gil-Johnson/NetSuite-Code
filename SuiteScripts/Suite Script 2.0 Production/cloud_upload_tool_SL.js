 ...
 */
define(['N/file', 'N/format', 'N/record', 'N/ui/serverWidget', 'N/search', '/SuiteScripts - Globals/lodash.js', 'N/error', 'N/runtime'],
/**
 * @param {file} file
 * @param {format} format
 * @param {record} record
 ...
 */
function(file, format, record, ui, search, lodash, error, runtime) {
    ...
    function onRequest(context) {
    	 ...
    	 if (context.request.method === 'GET') {  
    		 ...
    		 var form = ui.createForm({
                 title: 'Upload CSV File with Cloud Data'
             }); 

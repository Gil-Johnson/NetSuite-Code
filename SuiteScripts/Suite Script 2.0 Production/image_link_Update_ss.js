...
//	                        if(isCustom == true && league == ''){
//	    		        		//  log.debug('isCustom', isCustom);
//	    		        		  
//	    		        		  folder = 'Custom';
//	    		        		  
//	    		        	  }	
//	    		        	  else if (league == '' && isCustom == false){
//	    		        		  
//	    		        		  folder = 'Custom';
//	    		        		  
//	    		        	  }
...
//	    		        	  }
	                    	...
	                    	//  log.debug('folder', folder); College
			                ...
			                if(res.code != 404 && res.code != 400){
			                	...
			                	try{
			                		var subid =   record.submitFields({
					                    ...
					                    id: parseInt(itemid),
					                    values: {
					                    	custitem_image1: main_url,
					                    	custitemthumbnail_image: thumb_url,
					                    	custitem_highresimage: url,
					                    	custitem_thumbnail1:thumb_url

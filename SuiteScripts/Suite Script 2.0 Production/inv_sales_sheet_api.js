	  ...
	  for (var i = 0; i < searchResult.length; i++) {
	     ...
	     //custitemthumbnail_image  custitem_highresimage
 		  ...
 		  if(i % 2 == 0 && lastResult == true){
 			...
 			body += "<tr>"+
		    	"<td><img src=' " + imgLink + " \' height='89' width='130'> </img></td>" + 
			    " <td><b>Name:</b>"+nameEscaped+"<br></br><b>UPC:</b>"+upccode+"<br></br><b>Qty Aval:</b>"+quantityavailable+"<br></br><b>Time to Build:</b>"+leadTime+"days<br></br><br></br>"+salesDesEscaped+"</td>" +
			    "</tr>";
 		...
 		//	 log.debug('is an odd number', i);
 	            body +=  "<td><img src='" + imgLink + " \' height='89' width='130'> </img> </td> " + 
			    "<td> <b>Name:</b> " + nameEscaped + "<br></br> <b>UPC:</b> " + upccode + "<br></br> <b>Qty Aval:</b> " + quantityavailable + " <br></br> <b>Time to Build: </b>" + leadTime + " days  <br></br><br></br>" + salesDesEscaped + "</td>" +
 			    "</tr>";
 		...
 		// log.debug('i',  i);
 		 ...
 		 log.debug('search time', (endTime - startTime) + "ms");
			 ...
			 var xmlStr = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                 ...
                 +   "</tr>\n"
                 +   "<tr> <td line-height=\"130%\" align=\"left\" colspan=\"2\" background-color=\"black\" color=\"white\"><b>MARGARITAVILLE</b>\n"
                 +   "</td> </tr>\n"
                 +  "</table>\n"        
                 +  "</macro>\n"
                 +	"<macro id=\"myfooter\">\n"
			 ...
			 pdfFile.name = "MARGARITAVILLE_" + today + '.pdf';

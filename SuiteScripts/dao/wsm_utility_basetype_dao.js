var WsmUtilityBaseType = (function () {
    return {
        ...
        getAll: function (fils) {
            ...
            try {
                ...
                nlapiLogExecution('ERROR', 'WsmUtilityBaseType.getAll', e.toString());
                throw e;
            }
            return arr;
        },
        getAllSortBy: function (fils, sortCol, isDesc) {
            ...
            try {
                ...
                nlapiLogExecution('ERROR', 'WsmUtilityBaseType.getAllSortBy', e.toString());
                throw e;
            }
            return arr;
        },
        ...
        upsert: function (arg) {
            ...
            if (arg) {
                try {
                    ...
                    nlapiLogExecution('ERROR', 'WsmUtilityBaseType.upsert', e.toString());
                    throw e;
                }
            }
            return id;
        ...
        remove: function (id) {
            try {
                ...
                nlapiLogExecution('ERROR', 'WsmUtilityBaseType.delete', e.toString());
                throw e;
            }
        }
    };
